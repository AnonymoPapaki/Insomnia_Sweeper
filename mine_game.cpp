...
static void GameUpdateAndRender(game_memory* GameMemory, game_buffer* BackBuffer, game_raw_input* PreviousRawInput, game_raw_input* CurrentRawInput)
{
